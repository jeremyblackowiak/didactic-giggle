...
5. (Optional) Run the script with custom input arguments.
     ...
     - Use the `--test-interval`, `--info-logs` flags to customize your command. See the table below for details.

     ```bash
     poetry run python src/main.py --endpoints "src/sample_input.yaml" --test-interval 5 --info-logs
     ```
